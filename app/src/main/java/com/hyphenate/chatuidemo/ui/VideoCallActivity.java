...
import com.hyphenate.chatuidemo.faceunity.CameraRenderer;
import com.hyphenate.chatuidemo.faceunity.PreferenceUtil;
...
//    private Button recordBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        boolean isOpenFu = PreferenceUtil.ON.equals(PreferenceUtil.getString(this, PreferenceUtil.KEY_FACEUNITY_ISON));
        ...
        if (isOpenFu) {
            beautyControlView.setOnFaceUnityControlListener(mCameraRenderer.getFURenderer());
        } else {
