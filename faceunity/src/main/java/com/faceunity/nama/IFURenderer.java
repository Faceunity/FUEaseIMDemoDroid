...
abstract class IFURenderer {
     ...
     * @return
     */
    public abstract byte[] onDrawFrameSingleInput(byte[] img, int width, int height);
     ...
     * @return
     */
    public abstract byte[] onDrawFrameDoubleInput(int textureId,byte[] img, int width, int height);
